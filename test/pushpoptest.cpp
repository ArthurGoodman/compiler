...
PushPopTest::PushPopTest()
    ...
    $("push DWORD PTR [ebx+ebx*2+0x1]", "ff 74 5b 01", [=]() { dump(); });
    $("push DWORD PTR [ebx+ebx*2+0x100]", "ff b4 5b 00 01 00 00", [=]() { dump(); });
    $("push DWORD PTR ds:0x1", "ff 35 01 00 00 00", [=]() { dump(); });
    $("push DWORD PTR ds:0x100", "ff 35 00 01 00 00", [=]() { dump(); });
    ...
    $("pop DWORD PTR [ebx+ebx*2+0x1]", "8f 44 5b 01", [=]() { dump(); });
    $("pop DWORD PTR [ebx+ebx*2+0x100]", "8f 84 5b 00 01 00 00", [=]() { dump(); });
    $("pop DWORD PTR ds:0x1", "8f 05 01 00 00 00", [=]() { dump(); });
    $("pop DWORD PTR ds:0x100", "8f 05 00 01 00 00", [=]() { dump(); });
