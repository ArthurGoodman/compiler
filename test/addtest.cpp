...
AddTest::AddTest()
    ...
    $("add ebx,DWORD PTR [ebx+ebx*2]", "03 1c 5b", [=]() { dump(); });
    $("add ebx,DWORD PTR [ebx+ebx*2+0x1]", "03 5c 5b 01", [=]() { dump(); });
    $("add ebx,DWORD PTR ds:0x1", "03 1d 01 00 00 00", [=]() { dump(); });
    ...
    $("add DWORD PTR [ebx+ebx*2],ebx", "01 1c 5b", [=]() { dump(); });
    $("add DWORD PTR [ebx+ebx*2+0x1],ebx", "01 5c 5b 01", [=]() { dump(); });
    $("add DWORD PTR ds:0x1,ebx", "01 1d 01 00 00 00", [=]() { dump(); });
    ...
    $("add DWORD PTR [ebx+ebx*2],0x1", "83 04 5b 01", [=]() { dump(); });
    $("add DWORD PTR [ebx+ebx*2+0x1],0x1", "83 44 5b 01 01", [=]() { dump(); });
    ...
    $("add DWORD PTR [ebx+ebx*2],0x100", "81 04 5b 00 01 00 00", [=]() { dump(); });
    $("add DWORD PTR [ebx+ebx*2+0x1],0x100", "81 44 5b 01 00 01 00", [=]() { dump(); });
}
