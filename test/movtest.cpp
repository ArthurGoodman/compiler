...
MovTest::MovTest()
    ...
    $("mov ebx,DWORD PTR [ebx+ebx*2]", "8b 1c 5b", [=]() { dump(); });
    $("mov ebx,DWORD PTR [ebx+ebx*2+0x1]", "8b 5c 5b 01", [=]() { dump(); });
    $("mov ebx,DWORD PTR ds:0x1", "8b 1d 01 00 00 00", [=]() { dump(); });
    ...
    $("mov DWORD PTR [ebx+ebx*2],ebx", "89 1c 5b", [=]() { dump(); });
    $("mov DWORD PTR [ebx+ebx*2+0x1],ebx", "89 5c 5b 01", [=]() { dump(); });
    $("mov DWORD PTR ds:0x1,ebx", "89 1d 01 00 00 00", [=]() { dump(); });
    ...
    $("mov DWORD PTR [ebx+ebx*2],0x1", "c7 04 5b 01 00 00 00", [=]() { dump(); });
    $("mov DWORD PTR [ebx+ebx*2+0x1],0x1", "c7 44 5b 01 01 00 00 00", [=]() { dump(); });
    ...
    $("mov DWORD PTR [ebx+ebx*2],0x100", "c7 04 5b 00 01 00 00", [=]() { dump(); });
    $("mov DWORD PTR [ebx+ebx*2+0x1],0x100", "c7 44 5b 01 00 01 00 00", [=]() { dump(); });
}
